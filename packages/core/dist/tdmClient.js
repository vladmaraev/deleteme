...
exports.tdmDmMachine = void 0;
const xstate_1 = require("xstate");
const { send, assign, choose } = xstate_1.actions;
...
const nlInput = (sessionObject, ddd, moves, hypotheses) => ({
    version: "3.3",
    session: Object.assign(Object.assign({}, sessionObject), { ddd: ddd, moves: moves }),
    request: {
